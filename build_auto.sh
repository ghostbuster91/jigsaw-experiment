#!/bin/bash
javac mod1/module-info.java mod1/p1/api/Greeter1.java mod1/p1/internal/Utils.java
javac mod2/module-info.java mod2/p2/api/Greeter2.java mod2/p2/internal/Utils.java
